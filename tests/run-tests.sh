...
# shellcheck source=tests/test-follow-dedup.sh
...
# shellcheck source=tests/test-cron.sh
...
# shellcheck source=tests/test-ssh.sh
...
# shellcheck source=tests/test-exit-codes.sh
source "$TESTS_DIR/test-exit-codes.sh"
